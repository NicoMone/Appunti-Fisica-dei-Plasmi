...
\begin{multicols}{2}
	...
	Ad esempio si vede come nel sistema (x,y,z) il vettore d'onda sia $(k, 0, 0 )_{k,y,\bar z}\, =\, (k\sin\theta, 0, k\cos\theta)_{x,y,z} \equiv (k_\perp, 0 , k_\parallel)_{x,y,z}$
\end{multicols}
...
\begin{equation}
	...
	\begin{cases}
		...
		c^2_s\, \rho_1\,
		\begin{pmatrix}
			k_\perp\\ 0 \\ -k_\parallel
		\end{pmatrix}   
		\ +\ 
		\frac{B_0}{4\pi}
		\begin{pmatrix}
			k (-\cos\theta b_x + \sin\theta b_z)\\ -k_\parallel b_y\\ 0
		\end{pmatrix} 
		\\
		-\,\omega\,
		\begin{pmatrix}
		...
		\ =\ B_0\,
		\begin{pmatrix}
			k_\parallel u_x\\ k_\parallel u_y\\ -k_\perp u_x
		\end{pmatrix}  
	\end{cases}
\end{equation} 

Se ci limitiamo ad osservare la proiezione lungo $\hat y$ riduciamo il sistema a:
\[\begin{cases}
