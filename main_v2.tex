...
Si nota che per la densità di massa il contributo è dato principalmente dagli ioni, come per la velocità dove al primo ordine potremmo approssimare $\bar u \sim \vec u_i$.
...
Guardando al primo termine vediamo che questo rappresenta ora la variazione dell'energia interna:
