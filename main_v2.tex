...
% Configura lo stile dell'epigrafe
\usepackage{epigraph}
%\setlength{\epigraphwidth}{0.8\textwidth} % Larghezza
%\renewcommand{\epigraphflush}{flushright}   % Allineamento
\renewcommand{\epigraphsize}{\small}        % Dimensione testo
%\renewcommand{\epigraphfont}{\itshape}      % Stile (corsivo)
\renewcommand{\epigraphrule}{0pt}           % Linea sopra/basso (0 = nessuna)
...
\begin{titlepage}
	...
	\vspace{2 cm}
        ...
        {\Large\scshape Appunti di: \par Nicolò Mone\par Andrea Galiati }
        
        \vspace{2 cm}
        {\large Tratti dal corso 'Fisica dei plasmi'\par del prof. F. Califano, \par anno 2025 \par}
	\vspace{1 cm}
...
% PROLOGO
\chapter*{Prologo}
\addcontentsline{toc}{chapter}{Prologue} % Aggiunge il prologo all'indice (opzionale)
Questo libro (ormai lo considero tale vista la portata) nasce dagli appunti presi durante il corso di \textit{Fisica dei Plasmi} tenuto dal prof. Francesco Califano nell'anno accademico 2025-2026. \\

La necessità di trascrivere quanto svolto a lezione si rese immediatamente necessario vista la struttura oscura del corso, dopo mesi passati a cercare appigli in letteratura (con tante difficoltà data la diversità imbarazzante con cui la fisica dei plasmi viene trattata dai diversi autori) il risultato non è altro che un collage di quel che ho potuto trovare riguardo i temi presentati a lezione facendo riferimento principalmente ai due libri di riferimento del corso: il Pucella-Segre ed il Krall.

Ho fatto riferimento anche ad altri libri come il Freidberg ed alcuni altri vecchi classici disponibili in biblioteca (nella disperata ricerca di libri che si capissero, al contrario del Pucella-Segre e del Krall su cui evito ulteriori commenti). 

Questo senza considerare materiale che ho riguardato di altri corsi seguiti in passato per prendere spunto nel migliorare le spiegazioni, come "Engineering of fusion reactors" del professor Alessio Pesetti, tenuto al dipartimento di ingegneria nucleare nell'anno accademico 2024-2025, ed i corsi dell'EPFL 'Plasma physics: introduction' e 'Plasma physics: applications' pubblici sulla piattaforma edX online.\\

Ringrazio i ragazzi che mi hanno passato i loro appunti presi a lezione: Federico Spinello, Alessandro Coppellotti e Marcello Siciliano. Senza il loro aiuto questo lavoro non sarebbe stato possibile viste le sovrapposizioni di lezioni ed il fatto che di conseguenza avessi perso quasi un terzo delle lezioni. 

Ringrazio soprattutto Andrea Galiati, che ha contribuito nella scrittura di alcuni passaggi ma soprattutto ha svolto un indispensabile lavoro di revisione della coerenza di questo testo.\\

Il testo è un'elaborazione personale, non delle 'sbobine', né una scrittura passiva basata sulle lezioni, né un copia-incolla da qualche libro, pertanto per la proprietà intellettuale mi appartiene. Sentiatevi liberi di scaricarlo, stamparlo, copiarlo, rubarlo, insomma fateci quel che volete. Spero che il mio sforzo serva a qualcuno a non abbandonare il corso di plasmi come visto fare da tanti colleghi.

Vi prego di segnalarmi errori e possibili migliorie (lo so ce ne sarebbero molte da fare), potete trovarmi facilmente su ogni social non essendoci miei omonimi quindi evito di lasciarvi la mail personale per evitare possibile spam.

Buono studio,    

\vspace{1cm}
\hfill \textit{Nicolò Mone}
...
\chapter{Seminario sui plasmi spaziali} 
Professor Henry osservatore di Nizza e centro plasmi di Orleans. Vediamo come mai i plasmi spaziali sono così importanti dal punto di vista osservativo.
