...
Dalla fluidodinamica sappiamo che possiamo scrivere il campo 2D come gradiente di un potenziale $\psi$:

\[\vec b\ =\ \nabla\psi\times\hat e_z\ =\ \partial_y\psi\hat e_x-\partial_x\psi\hat e_y,\hspace{2cm}\vec u\ =\ \nabla\phi\times\hat z\ =\ \partial_y\phi\hat x-\partial_x\phi\hat y\] 
