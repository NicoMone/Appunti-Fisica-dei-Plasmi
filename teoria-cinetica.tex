...
Per esplicitarla $\vec a_i\, =\, \frac{q}{m}(\vec E\,+\, \vec v_i\cdot \vec B\, /\, c )$, si arriva così, nel limite in cui è possibile ignorare lo scattering di particelle, all'equazione cardine della descrizione statistica dei plasmi, l'\textbf{equazione di Vlasov}:
...
&=\ f_\alpha \vec D \frac{\partial \vec v_\alpha }{\partial\vec v_\alpha}\, +\, \vec v_\alpha D\cdot \frac{\partial f_\alpha }{\partial\vec v_\alpha} \end{split}\]
