...
\[ \begin{cases}
	\displaystyle\frac{\partial }{\partial t} (\delta \rho)\ =\ \rho_0\, \displaystyle\frac{\partial}{\partial x} (\delta u)\qquad \text{eq. di continuità linearizzata}\ ,\\ \\
	...
	\delta P\, =\, c_s^2\, \delta \rho\qquad \text{politropica linearizzata}
\end{cases} \]
...
%
%
\section{Teoremi fondanti nella fisica dei plasmi} 
