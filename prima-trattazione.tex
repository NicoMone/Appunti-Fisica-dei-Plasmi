...
Prendiamo invece dall'equazione del moto, trascurando le collisioni ed il termine gravitazionale, andiamo a linearizzare l'equazione tenendo i termini di ordine più basso, ponendo $\vec u_0 = 0$ e la sua derivata $\partial_t u_0 = 0$ per poi sottrarre la forma di equilibrio $\rho_0 D_t u_0 = -\vec \nabla P_0$:
