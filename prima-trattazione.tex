...
Quindi, dimensionalmente è tale che $D/L\, \sim\, 1/\tau$, cioè:
...
\[\omega\ =\ \omega_p^2\, \left(1+\gamma\frac{k^2v_{th,e}}{\omega_p^2}\right)
...
\begin{figure}[H]
	...
	\caption{Relazione di dispersione di onda e.m. trasversa ($\vec k \parallel \vec E$)}
