...
Ora si nota che siamo partiti da 2 equazioni quindi possiamo ricavarne altrettante, c'è ancora dell'informazione da estrarre dall'eq.(\ref{moto}) del moto qui sopra riportata. Dopo che siamo andati sopra a fare la somma per trovare l'equazione del moto del singolo fluido, se moltiplichiamo per $q_\alpha$ e quindi facciamo la differenza delle singole equazioni del moto delle due specie, quella che troveremo sarà l'equazione di Ohm generalizzata. 
...
Per semplificare i conti assumiamo che gli ioni siano protoni così da avere carica $+e$:
